  ...
  <div class="home">
    ...
    <div class="row">
      <div class="v-card" @click="setTurned">
        <figure :class="[viewType, turned ? 'turned' : '']" figure-role="group">
          ...
          <figcaption v-if="turned" ref="contact" class="contact">
              ...
              <div class="light block">Mühlenbach 2 | 50676 Köln</div>
              <div class="reachout">
                <div class="light block">Tel: <a class="block" href="tel:017664766895">0176 647 668 95</a></div>
                <div class="light block">Email: <a class="block" href="mailto:info@jonasdonker.de">info@jonasdonker.de</a></div>
      ...
      <div>
          <h3>Erfahre mehr</h3>
          <p>
            Wenn du mehr über mich erfahren willst, klicke auf die Visitenkarte und schreib mir eine Email oder ruf mich an.
          </p>
